...
namespace std
{
    ...
    template<> struct less<DirectX::Math::Rectangle>
    {
        bool operator()(const DirectX::Math::Rectangle& r1, const DirectX::Math::Rectangle& r2) const noexcept
        {
            return ((r1.x < r2.x)
                    || ((r1.x == r2.x) && (r1.y < r2.y))
    ...
    {
        bool operator()(const DirectX::Math::Vector2& V1, const DirectX::Math::Vector2& V2) const noexcept
        {
    ...
    {
        bool operator()(const DirectX::Math::Vector3& V1, const DirectX::Math::Vector3& V2) const noexcept
        {
            return ((V1.x < V2.x)
                    || ((V1.x == V2.x) && (V1.y < V2.y))
    ...
    {
        bool operator()(const DirectX::Math::Vector4& V1, const DirectX::Math::Vector4& V2) const noexcept
        {
            return ((V1.x < V2.x)
                    || ((V1.x == V2.x) && (V1.y < V2.y))
                    || ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
    ...
    {
        bool operator()(const DirectX::Math::Matrix& M1, const DirectX::Math::Matrix& M2) const noexcept
        {
    ...
    {
        bool operator()(const DirectX::Math::Plane& P1, const DirectX::Math::Plane& P2) const noexcept
        {
            return ((P1.x < P2.x)
                    || ((P1.x == P2.x) && (P1.y < P2.y))
    ...
    {
        bool operator()(const DirectX::Math::Quaternion& Q1, const DirectX::Math::Quaternion& Q2) const noexcept
        {
            return ((Q1.x < Q2.x)
                    || ((Q1.x == Q2.x) && (Q1.y < Q2.y))
    ...
    {
        bool operator()(const DirectX::Math::Color& C1, const DirectX::Math::Color& C2) const noexcept
        {
            return ((C1.x < C2.x)
                    || ((C1.x == C2.x) && (C1.y < C2.y))
    ...
    {
        bool operator()(const DirectX::Math::Ray& R1, const DirectX::Math::Ray& R2) const noexcept
        {
    ...
    template<> struct less<DirectX::Math::Viewport>
    {
        bool operator()(const DirectX::Math::Viewport& vp1, const DirectX::Math::Viewport& vp2) const noexcept
        {
