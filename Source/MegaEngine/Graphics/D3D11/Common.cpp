...
HRESULT DirectX::CompileShader(LPCSTR pSrcData, SIZE_T SrcDataLen, LPCSTR pFileName, LPCSTR szEntryPoint,
    LPCSTR szShaderModel, ID3DBlob** ppBlobOut)
{
    ...
    hr = D3DCompile(pSrcData, SrcDataLen, pFileName,
        nullptr, nullptr, szEntryPoint,
        szShaderModel, dwShaderFlags, 0,
